...
public class Player extends Mobile{
    private static final Sprite sprite = new Sprite('P', "anykey1.png");
    private static final Sprite spriteTurnLeft = new Sprite('P', "pLeft1.png");
    private static final Sprite spriteTurnRight = new Sprite('P', "pRight1.png");
    /** The Constant spriteTurnUp. */
    private static final Sprite spriteTurnUp = new Sprite('P', "pUp1.png");
    private static final Sprite sprite1TurnUp = new Sprite('P', "pUp2.png");
    /** The Constant spriteTurnDown. */
    private static final Sprite spriteTurnDown = new Sprite('P', "pDown1.png");
